...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="text-white py-5 flex justify-between items-center px-4">
        <div className="text-lg font-semibold cursor-pointer">
          <span className="text-[#8245ec]">&lt;</span>
          <span className="text-white">Mohd</span>
          <span className="text-[#8245ec]">/</span>
          <span className="text-white">Arham</span>
          <span className="text-[#8245ec]">&gt;</span>
        </div>
        ...
        <div className="hidden md:flex items-center space-x-8 text-gray-300">
          ...
          <div className="flex space-x-4">
            <a
              href="https://github.com/MohdArham421"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/mohdarham4210/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-[#8245ec]"
            >
